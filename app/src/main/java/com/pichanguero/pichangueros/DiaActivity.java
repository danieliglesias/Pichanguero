...
public class DiaActivity extends ListActivity {
    // Connection detector
    ...
    // albums JSON url
    private static final String URL_ALBUMS = "http://10.0.2.2/arriendo/date.php";

    // ALL JSON node names
    private static final String TAG_ID = "id";
    private static final String TAG_NAME = "dia";
    ...
    class LoadAlbums extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DiaActivity.this);
