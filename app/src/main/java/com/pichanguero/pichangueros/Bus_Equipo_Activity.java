...
public class Bus_Equipo_Activity extends ListActivity {
    // Connection detector
    ...
    // ALL JSON node names
    private static final String TAG_ID = "Usu_Mail";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                ...
                Intent i = new Intent(getApplicationContext(), Bus_Enviar_Activity.class);
    ...
    class LoadAlbums extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Bus_Equipo_Activity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            final String URL_ALBUMS = "http://10.0.2.2/mail/recive.php?nivelid="+nivelid+"";
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Bus_Equipo_Activity.this, albumsList,
