...
public class Capitan_Administra_Activity extends Activity {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                if(succ.equals("succs")) {
                    ...
                    Intent i = new Intent(Capitan_Administra_Activity.this, GreetingProce_Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jugadores_menu);
