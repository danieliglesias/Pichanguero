...
public class Bus_Nivel_Activity extends ListActivity {
    // Connection detector
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                ...
                Intent i = new Intent(getApplicationContext(), Bus_Equipo_Activity.class);
    ...
    class LoadAlbums extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Bus_Nivel_Activity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Bus_Nivel_Activity.this, albumsList,
