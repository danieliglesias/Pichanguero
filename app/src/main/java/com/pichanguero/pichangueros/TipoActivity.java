...
public class TipoActivity extends ListActivity {
    ...
    private static final String TAG_NAME = "Tipo";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                ...
                Intent i = new Intent(getApplicationContext(), CanchaActivity.class);

                // send album id to tracklist activity to get list of songs under that album
                String album_name = ((TextView) view.findViewById(R.id.album_name)).getText().toString();
                String album_id = ((TextView) view.findViewById(R.id.album_id)).getText().toString();
                i.putExtra("TIPOID", album_id);
                i.putExtra("TIPO", album_name);
    ...
    class LoadAlbums extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TipoActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            final String URL_ALBUMS = "http://10.0.2.2/arriendo/Tipo.php?centroid="+ centroid;
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            TipoActivity.this, albumsList,
                            R.layout.list_tipo, new String[] { TAG_ID,
                            TAG_NAME }, new int[] {
