...
public class HoraActivity extends ListActivity {
    // Connection detector
    ...
    private static final String TAG_NAME = "hora";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                ...
                Intent i = new Intent(getApplicationContext(), ConfirmaActivity.class);

                // send album id to tracklist activity to get list of songs under that album
                String album_id = ((TextView) view.findViewById(R.id.album_id)).getText().toString();
                i.putExtra("HORA", album_id);
                Intent intename = getIntent();


                final String cancha = (String) intename.getSerializableExtra("CANCHA");
                i.putExtra("CANCHA", cancha);
    ...
    class LoadAlbums extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HoraActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            final String URL_ALBUMS = "http://10.0.2.2/arriendo/Hora.php?centroid="+ centroid +"&cancha="+ cancha+"&fecha="+dia+"";
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            HoraActivity.this, albumsList,
                            R.layout.list_dias, new String[] { TAG_ID,
                            TAG_NAME }, new int[] {
